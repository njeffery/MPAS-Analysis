...
class TestAnalysisTask(TestCase):
    ...
    def test_checkGenerate(self):
        ...
        cores = {'timeSeriesOHC': 'ocean',
                 ...
                 'climatologyMapSeaIceTotalChlorophyllNH': 'seaIce',
        ...
        tags = {'timeSeriesOHC': ['timeSeries', 'ohc'],
                ...
                'climatologyMapSeaIceAerosolImpuritiesSH': ['climatology',
                                                            'horizontalMap',
                                                            'BGC'],
                'climatologyMapSeaIceTotalChlorophyllNH': ['climatology',
                                                           'horizontalMap',
                                                           'BGC'],
                'climatologyMapSeaIceTotalChlorophyllSH': ['climatology',
                                                           'horizontalMap',
                                                           'BGC'],
                'climatologyMapSeaIceDissolvedIronNH': ['climatology',
                                                        'horizontalMap',
                                                        'BGC'],
